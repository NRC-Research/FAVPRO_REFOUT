...
$1 -i PFM_test_ver_17.in -l ../../../../../tests/verification/outputs/load/ver_3.out -o PFM_test_ver_17.out -s ../FlawFiles/PWRsurf5.dat -w ../FlawFiles/PWRweld50.dat -p ../FlawFiles/PWRplate50.dat
