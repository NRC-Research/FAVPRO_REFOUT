...
$1 -i PFM_test_val_12.in -l ../../../../../tests/verification/outputs/load/val_11.out -o PFM_test_val_12.out -s ../FlawFiles/PWRsurf5.dat -w ../FlawFiles/Wzero.dat -p ../FlawFiles/Pzero.dat
